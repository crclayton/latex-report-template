...
\makenoidxglossaries
\renewcommand{\glstextformat}[1]{\textit{#1}} % make all items defined in the glossary italic

\newglossaryentry{Lorem}{
	name={Lorem},
	description={hold back, hold fast, take hold of, seize, catch }
}
...
\title{\huge Formal APA Report Template \\ \Large \medskip Subtitle}
